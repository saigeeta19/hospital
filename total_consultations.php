...
$("#view").click(function(){
    ...
    var doctor=$("#doctor").val();
                     ...
                     $.ajax({
                        type:"post",
                        url:"getconreports.php",
                        data:"fromdate="+fromdate +"&todate="+todate+"&doctor="+doctor,
...
<form name="patient_register" method="post" >
     <tr>
            <td colspan="5"><p id="panel">Total Consultations & Cash Report</p></td>
            </tr>
