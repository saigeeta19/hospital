...
echo " <tr>
 <td colspan='2' id='breakres'>Total Room Rent + Nursing Charges + Consultation</td>
...
if(mysqli_num_rows($query5)>0)
 ...
 {
 	$nudate=$row656['start_time'];
 	$nudate=date(" d-M-Y h:i a", strtotime($nudate));
	
	$nudate1=$row656['end_time'];
	if($nudate1=="")
 	{
 		$nudate1="Still Running";
 	}
	else {
		$nudate1=date(" d-M-Y h:i a", strtotime($nudate1));
	}
 	//$nudate1=date(" d-M-Y h:i a", strtotime($nudate1));
 ...
 echo " <tr>
 <td colspan='3' id='breakres'><a href='printpharmacy.php?ip=".$patient_ip_id."' target='_blank' ><input type='button' value='View Pharmacy' /></a></td>
 
 </tr>";
 echo " <tr>
 <td colspan='3' id='breakres'><a href='printbreakup.php?ip=".$patient_ip_id."' target='_blank' ><input type='button' value='Print' /></a></td>
