...
<script type="text/javascript" src="exceldata/tableExport.js"></script>
 <script type="text/javascript" src="exceldata/jquery.base64.js"></script>
<?php
function thours($start,$end)
{
 ...
 <form name="opd_list" method="post">
    <tr>
            <td colspan="5"><p id="panel">Today's Cash Payable</p></td>
            </tr>
    <tr>
                <td colspan="5">
            <p align="right">
...
$sql=mysqli_query($con,"SELECT * FROM patients WHERE uid='".$patient_id."'",$con);
                $sql1=mysqli_fetch_array($sql);
...
$sql88=mysqli_fetch_array($sql87);
  ...
  $depodate=date("d-m-Y", strtotime($sql558['date']));
            ...
            <td align='center'>$sql1[address] </a></td>
...
<script>
	$(function(){
		$("#export").click(function(){
			 ...
			 $('#tablepaging').tableExport({type:'excel',escape:'false'});
		});
