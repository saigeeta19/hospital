...
$entry_person=$entry1['name'];
 ...
 $query=mysqli_query($con,"SELECT * FROM investigation_entry WHERE bill_number='".$bill."'");
	 ...
	 $gender=$row['gender'];
      ...
      $investigation_fees=$row['investigation_fees'];
	...
	$inc=1; $tot=0;
        ...
        $query23=mysqli_query($con,"SELECT * FROM investigations_discounts WHERE bill_number='".$bill."'");
     ...
     $t="<html><table width='75%' style='font-size:14px ;padding-top:100px;padding-left:90px;line-height:30px;line-width:15px;'>
       ...
       <tr>
	    ...
	    ";
	    $query1=mysqli_query($con,"SELECT * FROM investigation_entry WHERE bill_number='".$bill."'");
	  while($row1=mysqli_fetch_array($query1))
		{
	    $inv1=$row1['investigation'];
	    $amt=$row1['investigation_fees'];
			$t=$t."<tr>
			<td>$inc</td>
			<td>$inv1</td>
			<td>Rs. $amt</td>
