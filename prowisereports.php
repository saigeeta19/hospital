...
$("#view").click(function(){
    ...
    var procedure=$("#procedure").val();
                     ...
                     $.ajax({
                        type:"post",
                        url:"getpromarkreports.php",
                        data:"fromdate="+fromdate +"&todate="+todate+"&procedure="+procedure,
...
<form name="patient_register" method="post" >
     <tr>
            <td colspan="5"><p id="panel">Procedure Wise Report</p></td>
            </tr>
        <table id="table11"  name="t1" border="2" width="100%" >
            <tr>
               ...
               <td id="headus">Procedures</td>
               <td><select name="procedure" id="procedure" required="required">
