...
<tr>
            <td colspan="5"><p id="panel">Cancel/Refund INV/PRO Bills</p></td>
            </tr>           
<table id="table" name="t1" border="4" width="100%">
            ...
            <tr>
                <td colspan="4"><p id="button" align="center"><input type="button" id="submit" name="submit" value="View Previous Transactions" /></p></td>
            </tr>
        </table>
 <div id="dialog">
