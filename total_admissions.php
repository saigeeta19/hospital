...
$("#view").click(function(){
	...
	var creditcompany=$("#creditcompany").val();
                     ...
                     $.ajax({
                        type:"post",
                        url:"getadmissionsreports.php",
                        data:"fromdate="+fromdate +"&todate="+todate+"&creditcompany="+creditcompany,
...
<form name="patient_register" method="post" >
     <tr>
            <td colspan="5"><p id="panel">Total Admissions Report</p></td>
            </tr>
            ...
            <tr>
			   ...
			   <td>Select Company</td>
                <td><select name="creditcompany" id="creditcompany">
                  ...
                  <?php
					$sql=mysql_query("SELECT * FROM credit_company_list",$con);
