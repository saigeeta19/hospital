...
<div id="menu">
	<ul class="group" id="menu_group_main">
		...
		<li class="item middle" id="four"><a href="products.php" class="main current"><span class="outer"><span class="inner settings">Products</span></span></a></li>   
...
<!-- CONTENT START -->
    ...
    <!--THIS IS A WIDE PORTLET-->
		<div class="portlet">
			...
			<div align="right"><a style="font-size:14px;" rel="facebox" href="addproduct.php">Add Product</a></div>
			</div>
			...
			<form action="" method="post">
					...
					<table cellpadding="1" cellspacing="1" id="resultTable">
						<thead>
							<tr>
								<th width="120px"  style="border-left: 1px solid #C1DAD7"> Product Name </th>
								<th> Rate </th>
								<th> Desciption </th>
								<!--<th> Image </th>-->
								<th> Action </th>
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td width="70px"><div align="center"><a rel="facebox" href="editproductetails.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
...
Website Administration by <a href="../index.htm">Design Master</a></div>
<!-- FOOTER END -->
