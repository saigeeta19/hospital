...
<form name="opd_entry" method="post" >
	<tr>
            <td colspan="4"><p id="panel">Procedure Billing</p></td>
            </tr>	
		...
		<div id="procedure" class="tab-section">
			<?php
			$pro=mysqli_query($con,"SELECT * FROM procedures_list ORDER BY procedure_name");
			 echo "<table width='100%'><tr>"; 
			   $x = 0; 
			   while($pro1 = mysqli_fetch_assoc($pro)) 
			   { 
			       echo "<td><input type='checkbox' name='pro_list[]' id='pro_list[]' value='".$pro1['procedure_name']."' />".$pro1['procedure_name']."</td>"; 
			       $x++; 
			       if ($x % 3 == 0) { echo "<tr>"; } 
			   } 
		     echo "</tr></table>";  
...
if($_POST['submit'])
{
	...
	foreach($_REQUEST['pro'] as $proce)
	{
                   ...
                   if($pmode=="Card")
        {
          ...
          $query=mysqli_query($con,"INSERT INTO `procedure_entry`(`bill_number`, `date`, `patient_id`,`age`,`gender`, `procedure`, `procedure_fees`,`mode`, `bank_name`, `holder_name`, `cheque_number`, `status`,due_status,due_reason, `entry_person`) VALUES ('".$bill_number."','".$date."','".$patient_id."','".$age."','".$gender."','".$p."','".$amt."','".$pmode."','".$card_bank_name."','".$card_holder."','".$cheque_number."','pro','".$due_status."','".$due_reason."','".$entry_person."')");
        }
        else if($pmode=="Cheque")
        {
            $query=mysqli_query($con,"INSERT INTO `procedure_entry`(`bill_number`, `date`, `patient_id`,`age`,`gender`, `procedure`, `procedure_fees`,`mode`, `bank_name`, `holder_name`, `cheque_number`, `status`,due_status,due_reason, `entry_person`) VALUES ('".$bill_number."','".$date."','".$patient_id."','".$age."','".$gender."','".$p."','".$amt."','".$pmode."','".$cheque_bank_name."','".$cheque_holder."','".$cheque_number."','pro','".$due_status."','".$due_reason."','".$entry_person."')");
           
            
        }
        else if($pmode=="Cash")
        {
            $query=mysqli_query($con,"INSERT INTO `procedure_entry`(`bill_number`, `date`, `patient_id`,`age`,`gender`, `procedure`, `procedure_fees`, mode,`status`,due_status,due_reason, `entry_person`) VALUES ('".$bill_number."','".$date."','".$patient_id."','".$age."','".$gender."','".$p."','".$amt."','".$pmode."','pro','".$due_status."','".$due_reason."','".$entry_person."')");
   ...
   $uid=$patient_id;
                ...
                $patient_name=$sql15['name'];
                  ...
                  $query777=  mysqli_query($con,"INSERT INTO `procedures_discounts`(`bill_number`, `discount_mode`, `discount_value`, `discount_amount`,discount_reason,date) VALUES ('".$bill_number."','".$pdmode."','".$pdval."','".$damt."','".$dis_reason."','".$date."')");
