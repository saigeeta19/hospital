...
echo "<input type='hidden' name='emergency' value='".$emer_charge."' />";
 ...
 $trent=$trent+$tnurse+$thousekeeping;
...
$query8=mysqli_query($con,"SELECT sum(amount) FROM deposits WHERE patient_ip_id='".$patient_ip_id."' && status='FSREF'");
 ...
 $totalbill1=$emer_charge+$regcharge+$trent+$otheramount+$investigation_amount+$ot_entry+$procedure_amount+$equipments_amount+$cons+$consultation_amount+$nutrition_amount;
 $totalbill=($emer_charge+$regcharge+$otheramount+$trent+$investigation_amount+$ot_entry+$procedure_amount+$equipments_amount+$cons+$consultation_amount+$nutrition_amount)-$discounts;
...
$sql3=mysqli_query($con,"SELECT sum(amount) FROM caution_deduction WHERE patient_ip_id='".$patient_ip_id."'");
 ...
 $tdeposit=$totaldeposit+$caution_deposit;
  ...
  <tr>
    ...
    <td align='center'>Rs. $regcharge</td>
</tr>
<tr>
    <td>Emergency Charges</td>
    <td align='center'>Rs. $emer_charge</td>
</tr>
  <tr>
    <td>Room Rent + Nursing Charges + Housekeeping Charges<input type='hidden' name='thou' id='thou' value='".$h."' /></td>
    <td align='center'>Rs. $trent</td>
</tr>

<tr>
    <td>Investigation Charges</td>
    <td align='center'>Rs. $investigation_amount</td>
</tr>
<tr>
    <td>Procedure Charges</td>
    <td align='center'>Rs. $procedure_amount</td>
</tr>
<tr>
    <td>Medical Equipemts</td>
    <td align='center'>Rs. $equipments_amount</td>
</tr>
<tr>
    <td>Consultation Charges (Under Doctor)</td>
    <td align='center'>Rs. $cons</td>
</tr>
<tr>
    <td>Consultation Charges</td>
    <td align='center'>Rs. $consultation_amount</td>
</tr>
<tr>
    <td>Nutrition Charges</td>
    <td align='center'>Rs. $nutrition_amount</td>
</tr>
<tr>
    <td>OT Charges</td>
    <td align='center'>Rs. $ot_entry</td>
</tr>
<tr>
    <td>Other Charges</td>
    <td align='center'>Rs. $otheramount</td>
</tr>
<tr>
...
<tr>
    <td><b>Total Deposits(Deposit+Caution Deposit)</b></td>
    <td align='center'><b>Rs. $tdeposit</b></td>
</tr>
<tr>
    <td><b>Total Refunds</b></td>
    <td align='center'><b>Rs. $refunds</b></td>
</tr>
<tr>
