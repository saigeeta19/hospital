...
<form name="users_list" method="post">
    <tr>
            <td colspan="5"><p id="panel">View All Investigations</p></td>
            </tr>
    <tr >
                <td colspan="5">
            <p align="right">
        ...
        <table id="tablepaging" class="yui" name="t1" border="4" width="100%" >
            ...
            <td align='center'>Rs. $row[investigation_amount]</td>
            <td align='center'><a href='edit_investigations.php?invid=$row[id]'><img src='images/edit.png' /></a>&nbsp;&nbsp;<a href='#' id='delete_$row[id]'><img src='images/cancel.png' /></a></td>
           </tr>
            ";
            $inc++;
