...
?>
    <?php include 'header.php'; ?>
     ...
     <?php
       $rec_limit = 20;
        $sql = "SELECT count(id) FROM pharmacy_entry GROUP BY bill_number ORDER BY STR_TO_DATE(`date`,'%d-%m-%Y %H:%i:%s') DESC";
        $retval = mysqli_query( $sql, $con );
         ...
         $sql = "SELECT * FROM pharmacy_entry GROUP BY bill_number ORDER BY STR_TO_DATE(`date`,'%d-%m-%Y %H:%i:%s') DESC LIMIT $offset, $rec_limit";
