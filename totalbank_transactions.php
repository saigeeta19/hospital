...
$("#view").click(function(){
	...
	var status=$("#status").val();
                     ...
                     $.ajax({
                        type:"post",
                        url:"getbanktransactions.php",
                        data:"fromdate="+fromdate +"&todate="+todate+"&stype="+stype+"&status="+status,
...
<form name="patient_register" method="post" >
     <tr>
            <td colspan="5"><p id="panel">Total Bank/Cheque Transactions Report</p></td>
            </tr>
