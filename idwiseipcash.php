...
$("#view").click(function(){
    ...
    var entry=$("#entry").val();
                     ...
                     $.ajax({
                        type:"post",
                        url:"getipdtranreports.php",
                        data:"fromdate="+fromdate +"&todate="+todate+"&entry="+entry,
...
<form name="patient_register" method="post" >
     <tr>
            <td colspan="4"><p id="panel">Total IPD Transactions</p></td>
            </tr>
        <table id="table11"  name="t1" border="2" width="100%" >
            <tr>
               ...
               <td id="headus">To</td>
               <td><input type="text" name="to_date" id="to_date" /><input type="hidden" name="entry" id="entry" value="<?php echo $logger; ?>" /></td>
