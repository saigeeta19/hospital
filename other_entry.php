...
if($_POST['submit'])
{
    ...
    $query=mysqli_query($con,"INSERT INTO other_entry(app_date,patient_ip_id,patient_id,other_name,amount,entry_person) VALUES ('".$date."','".$patient_ip_id."','".$patient_id."','".$surgery_name."','".$surgery_amount."','".$entry_person."')");
     if($query)
    {
...
<form name="add_ward" method="post">
        <tr>
            <td colspan="4"><p id="panel">OTHER Entry</p></td>
        </tr>
